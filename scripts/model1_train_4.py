...
def main():
    ...
    ## 🪲 debugging
    # group_features_df = pd.read_pickle ('tmp_selected_group_features.pkl')
    # technique_features_df = pd.read_pickle ('tmp_selected_technique_features.pkl')
    ...
    #                                                 object= 'technique', 
    #                                                 label_df= train_y_df)
    # train_dataset = build_dataset_2 (X_group_df= train_X_group_df, X_technique_df=train_X_technique_df, y_df= train_y_df, ragged_input= True)
    # train_dataset = train_dataset.batch(batch_size)
