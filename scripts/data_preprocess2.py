...
def main():
    ...
    #### SELECTING FEATURES
    technique_selected_features = ['defenses_bypassed', 'software_ID']
    group_selected_features = ['software_ID']
    
    #### CLEANING DATA
    technique_features, group_features, interaction_matrix = clean_data(save_as_csv = True)
    technique_features, group_features = select_features(technique_feature_names= technique_selected_features, group_feature_names=group_selected_features)
    
    #### INPUT: BUILDING FEATURES
    technique_features, group_features = build_features (
        technique_features_df = technique_features,
        technique_feature_names = technique_selected_features,
        group_features_df = group_features,
        group_features_names = group_selected_features
    )
