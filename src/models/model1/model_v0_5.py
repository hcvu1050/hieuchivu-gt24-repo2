...
class Model1(keras.Model):
    def __init__(self, input_sizes=None, name = None,
        ...
        self.vectorize_group_software_id =              tf.keras.layers.TextVectorization (max_tokens=463+2,output_mode= 'int', output_sequence_length= 46 , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_group_software_id'], name = 'vectorize_group_software_id')
        self.vectorize_technique_data_sources =         tf.keras.layers.TextVectorization (max_tokens=105+2,output_mode= 'int', output_sequence_length= 14 , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_data_sources'], name = 'vectorize_technique_data_sources')
        self.vectorize_technique_defenses_bypassed =    tf.keras.layers.TextVectorization (max_tokens=24+2 ,output_mode= 'int', output_sequence_length= 8  , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_defenses_bypassed'], name = 'vectorize_technique_defenses_bypassed')
        self.vectorize_technique_detection_name =       tf.keras.layers.TextVectorization (max_tokens=105+2,output_mode= 'int', output_sequence_length= 14 , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_detection_name'], name = 'vectorize_technique_detection_name')
        self.vectorize_technique_mitigation_id =        tf.keras.layers.TextVectorization (max_tokens=43+2 ,output_mode= 'int', output_sequence_length= 11 , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_mitigation_id'], name = 'vectorize_technique_mitigation_id')
        self.vectorize_technique_permissions_required = tf.keras.layers.TextVectorization (max_tokens=5+2  ,output_mode= 'int', output_sequence_length= 4  , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_permissions_required'], name = 'vectorize_technique_permissions_required')
        self.vectorize_technique_platforms =            tf.keras.layers.TextVectorization (max_tokens=11+2 ,output_mode= 'int', output_sequence_length= 10 , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_platforms'], name = 'vectorize_technique_platforms')
        self.vectorize_technique_software_id =          tf.keras.layers.TextVectorization (max_tokens=635+2,output_mode= 'int', output_sequence_length= 334, pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_software_id'], name = 'vectorize_technique_software_id')
        self.vectorize_technique_tactics =              tf.keras.layers.TextVectorization (max_tokens=14+2 ,output_mode= 'int', output_sequence_length= 4  , pad_to_max_tokens= True, split = None, vocabulary=vocabs ['input_technique_tactics'], name = 'vectorize_technique_tactics')
